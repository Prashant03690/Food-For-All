...
export let HorecaSignInForm = () => {
  ...
  const { rname, remail, rpassword, raddr, rphone } = donor;
  ...
  const onSubmit = async (e) => {
    e.preventDefault();
    await axios.post("http://localhost:8080/donorSignIn", donor);
    navigate('/donorlogin');
  };
  return (
    <div>
        ...
        <div className="row">
          <div className="col-4">
            ...
            <form action="#" method="get" className="bg-light p-3 mt-1 border rounded shadow-5" onSubmit={(e) => onSubmit(e)}>
              <h2 className="text-dark">Donor Sign In</h2>
              <div className="mb-3">
                <label for="name" className="form-label text-dark" style={{ textAlign: "left" }}><strong>Donor/Restaurent Name</strong></label>
                <input type="text"
