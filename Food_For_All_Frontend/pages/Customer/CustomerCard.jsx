        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-6">
              ...
              <div>
                <Link type="submit" className="btn btn-primary mt-4" to={`/userpage/${cid}/${cname}/${cphone}/${cemail}/${cityname}`}>Go Back</Link>&emsp;
                <Link className="btn btn-success mt-4" to={`/userpayment/${fpid}/${cid}/${cname}/${cphone}/${cemail}/${cityname}`} >Buy Product</Link>
              </div>
            </div>
            <div className="col-3">
