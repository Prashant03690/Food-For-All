        ...
        <div>
          <div className="container">
            <div className="row">
                    ...
                    <div className="row">
                      ...
                      <div className="col-7">
                        <div className="card-body">
                          ...
                          <hr></hr>
                          <p className="card-text">Name: {cname}</p>
                          <p className="card-text">Email: {cemail} </p>
                          <p className="card-text">Phone: {cphone} </p>
              ...
              <div className="col-3 mt-4">
                <Link className="btn btn-light mx-2" to={`/viewcart/${cid}/${cname}/${cphone}/${cemail}/${cityname}`} >View Cart</Link>
                <Link className="btn btn-light mx-2" to={`/myorders/${cid}/${cname}/${cphone}/${cemail}/${cityname}`} >My Orders</Link>
              </div>
